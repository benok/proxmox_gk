...
SAMPLES		= ss_kvm_alpine-docker.conf ss_kvm_debian-docker.conf ss_ulxc_alpine-docker.conf ss_plxc_alpine-docker.conf ss_ulxc_debian-docker.conf ss_plxc_debian-docker.conf
